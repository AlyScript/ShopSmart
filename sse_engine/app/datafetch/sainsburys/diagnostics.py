import sainsburys.locators as locators
import sainsburys.cat_handler as cat_handler
...
def calculate_scrape_time(verbose=False, est_page_speed=5.49):
...
# Speed: Iterations per second ::: Assumed from ALDI.
